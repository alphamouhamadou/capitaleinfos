  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-red-600 via-red-600 to-red-700 text-white shadow-md shadow-red-600/15">
      <div className="mx-auto max-w-7xl flex items-center h-8">
        {/* Label */}
        <div className="flex-shrink-0 flex items-center gap-2 pl-4 sm:pl-0 pr-4 sm:pr-5 relative z-10">
          <span className="relative flex h-1.5 w-1.5">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-white opacity-75" />
            <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-white" />
          </span>
          <span className="text-[9.5px] font-black uppercase tracking-[0.2em] text-white">
            En continu
          </span>
          <div className="hidden sm:block w-px h-3.5 bg-white/25" />
        </div>
        ...
        <div className="overflow-hidden flex-1 relative">
          ...
          <div className="animate-ticker whitespace-nowrap py-0 text-[12px] font-medium">
